        ...
        {!started ? (
          ...
          >
            ...
            <div style={{ marginTop: '4rem', opacity: 0.6 }}>
               ...
               <p style={{ fontSize: 'clamp(1rem, 5vw, 1.3rem)', fontWeight: 700, marginTop: '0.5rem', fontFamily: "'Comfortaa', cursive" }}>Santhosh Prasad & Siva bharathy</p>
            </div>
          </motion.div>
        ) : (
          <motion.div
          ...
          >
            ...
            >
              <div style={{ textAlign: 'center' }}>
                 ...
                 <p style={{ fontSize: 'clamp(1.1rem, 5vw, 1.4rem)', fontWeight: 700, color: '#4a3f35', fontFamily: "'Comfortaa', cursive" }}>Santhosh Prasad & Siva bharathy</p>
              </div>
